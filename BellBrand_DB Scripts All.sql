...
-- tables for CASH In & Out Transactions App.
SELECT * FROM BELL_BILLTYPE_MASTER

select * from tblVANCASH_IN_DETAILS WHERE CASHID=5299 AND ID=9728 

select * from BELL_DAILYCASHFLOW order by actiondate desc
select * from BELL_DAILYCASHFLOW_LOG
select * from bell_LineSalesManPayments
...
select * from bell_tblCashApproval
select * from BELL_CATEGORY_MASTER
select * from bell_lines
select * from BILLTYPE_MASTER
-------------
select * from bell_LineSalesManPendings  -- not using this.
...
,SALESMAN varchar(30),MOBILE varchar(20),LINE varchar(30),STATUS varchar(10) DEFAULT 'ACTIVE')

-- THIS IS NOT YET CREATED IN LOCAL DB
CREATE TABLE BELL_EMP_SALARY_PAYMENT
(ID int IDENTITY(1,1) NOT NULL,ACTIONDATE DATETIME DEFAULT sysdatetime(),STATUS varchar(10) DEFAULT 'ACTIVE',USERNAME VARCHAR(30),
PAIDDATE DATE, EMPNAME varchar(30), EMPTYPE varchar(20), SALARY MONEY, WORKINGDAYS INT,LEAVEDAYS INT,OT MONEY,ADVANCE MONEY,DEDUCTIONS MONEY,INCENTIVE MONEY, NETPAY MONEY
)


CREATE TABLE BELL_CATEGORY_MASTER
(ID int IDENTITY(1,1) NOT NULL,ACTIONDATE DATETIME DEFAULT sysdatetime()
,CATEGORY varchar(40),PURPOSE varchar(40),PERSON varchar(30),FIELDTYPE VARCHAR(3), STATUS varchar(10) DEFAULT 'ACTIVE',USERNAME VARCHAR(30),Amount Money)

CREATE TABLE BELL_DAILYCASHFLOW_LOG
(ID int IDENTITY(1,1) NOT NULL,
CATEGORY NVARCHAR(30),PURPOSE NVARCHAR(40),PAIDTOPERSON NVARCHAR(40),AMOUNT MONEY,
CATEGORY_NEW NVARCHAR(30),PURPOSE_NEW NVARCHAR(40),PAIDTOPERSON_NEW NVARCHAR(40),AMOUNT_NEW MONEY,
TRANSTYPE NVARCHAR(3),PAIDDATE DATE,
ACTIONDATE DATETIME DEFAULT SYSDATETIME(),USERNAME NVARCHAR(30)
)

--to delete default constraint
--ALTER TABLE BELL_DAILYCASHFLOW DROP CONSTRAINT DF__BELL_DAIL__ACTIO__060F8196

--SELECT * INTO BELL_DAILYCASHFLOW_25Mar25 from BELL_DAILYCASHFLOW

--ALTER TABLE BELL_DAILYCASHFLOW ALTER COLUMN ACTIONDATE DATETIME 
--ALTER TABLE BELL_DAILYCASHFLOW ADD CONSTRAINT DF_ACTIONDATE_DEFAULT DEFAULT SYSDATETIME() FOR ACTIONDATE;
--alter table BELL_DAILYCASHFLOW add due_date date
alter table bell_dailycashflow add Seq_No int
alter table bell_dailycashflow alter column MOREDETAILS NVARCHAR(200)

--DROP TABLE BELL_DAILYCASHFLOW
CREATE TABLE BELL_DAILYCASHFLOW
(ID int IDENTITY(1,1) NOT NULL,
CATEGORY NVARCHAR(50),PAIDDATE DATE,
PURPOSE NVARCHAR(50),PAIDTOPERSON NVARCHAR(50),AMOUNT money,PAYMENT_MODE NVARCHAR(20), TRANSTYPE NVARCHAR(10),MOREDETAILS NVARCHAR(200)
,ACTIONDATE DATETIME DEFAULT sysdatetime(),USERNAME NVARCHAR(30),STATUS NVARCHAR(10) DEFAULT 'PENDING',FILEINFO NVARCHAR(30),SEQ_NO INT,due_date date )

-- alter table billtype_master add MasterType VARCHAR(30)
--alter table billtype_master drop column FieldType 

CREATE TABLE BILLTYPE_MASTER
(ID int IDENTITY(1,1) NOT NULL,
BILLTYPE NVARCHAR(20),
MOREDETAILS NVARCHAR(50),[STATUS] NVARCHAR(10) DEFAULT 'ACTIVE',FIELD_TYPE VARCHAR(10),
ACTIONDATE DATETIME DEFAULT SYSDATETIME(),USERNAME NVARCHAR(30),FieldType VARCHAR(30) )

--insert into BELL_Masterdata (ItemType,[Desc],ItemValue) values ('OPEN_BALANCE','PENING BALANCE','100');

-- alter table tblVANSALESBILL_DETAILS add Driver varchar(30) 
--alter table tblvansalesbill_details add Vehicle_No varchar(20)
--alter table tblvansalesbill_details ALTER column diesel decimal(10,2)
--alter table tblvansalesbill_details ALTER column mileage decimal(10,2)
--CREATE TABLE Bell_VANSALESBILL_DETAILS
CREATE TABLE tblVANSALESBILL_DETAILS
(ID int IDENTITY(1,1) NOT NULL,CASHID int,
LINE NVARCHAR(30),SALESMAN NVARCHAR(30),BILLDATE DATE,TOTALAMT INT,TOTCASH_IN INT,TOTCASH_OUT INT,
GRANDTOTAL INT,TOTAL_KM INT, DIESEL INT,MILEAGE INT,TOTAL_DUE INT,
ACTIONDATE DATETIME DEFAULT SYSDATETIME(),USERNAME NVARCHAR(30),Vehicle_No varchar(20),Driver varchar(30)  )

--CREATE TABLE Bell_VANCASH_IN_DETAILS
CREATE TABLE tblVANCASH_IN_DETAILS
(ID int IDENTITY(1,1) NOT NULL,
CASHID INT, VID INT, DENOMINATION NVARCHAR(15), COUNTING INT, TOTAL MONEY,
ACTIONDATE DATETIME DEFAULT SYSDATETIME(),Received varchar(3))

--CREATE TABLE Bell_VANCASH_OUT_DETAILS
CREATE TABLE tblVANCASH_OUT_DETAILS
(ID int IDENTITY(1,1) NOT NULL,
CASHID INT, VID INT,EXPENS NVARCHAR(20), COUNTING INT, TOTAL MONEY,
ACTIONDATE DATETIME DEFAULT SYSDATETIME() )

CREATE TABLE bell_tblCashApproval
(ID int IDENTITY(1,1) NOT NULL,OpenBal money,TotCashInHand money,
TotCashIn money,TotCashOut money, TransDate DATE,
ACTIONDATE DATETIME DEFAULT SYSDATETIME(),USERNAME NVARCHAR(30), STATUS VARCHAR(10) DEFAULT 'Approved'
)

--ALTER TABLE BELL_DAILYCASHFLOW ADD TOTAL_AMT MONEY

CREATE TABLE bell_Lines (
ID int IDENTITY(1,1) NOT NULL,LINE NVARCHAR(50), [status] NVARCHAR(10) default 'Active', value1 varchar(10),displayorder int )


--CREATE TABLE BELL_LineSalesManPendings(
CREATE TABLE tblLineSalesManPendings (
ID int IDENTITY(1,1) NOT NULL,CASHID INT,VID INT,LINE NVARCHAR(30),SALESMAN NVARCHAR(30),PARTYNAME NVARCHAR(30),
MOBILE NVARCHAR(10),BILLDATE DATE,AMOUNT_DUE INT,ACTIONDATE DATETIME DEFAULT SYSDATETIME(), RECEIVED CHAR(1) )
ALTER TABLE tblLineSalesManPendings ADD RECEIVED CHAR(1)

--CREATE TABLE BELL_LineSalesManPayments(
CREATE TABLE tblLineSalesManPayments(
ID int IDENTITY(1,1) NOT NULL,CASHID INT,LINE NVARCHAR(30),SALESMAN NVARCHAR(30),PARTYNAME NVARCHAR(30),
BILLDATE DATE,PAIDDATE DATE,AMOUNT MONEY,UserName Varchar(30),ACTIONDATE DATETIME DEFAULT SYSDATETIME(),due_cashid int)

-- ,FileName Text(30),Vehicle_NO Text(20), Hospital Text(30)
...
[DESC] NVARCHAR(30),
[Status] VARCHAR(8) default 'Active',displayorder INT default 1,
ACTIONDATE datetime default SYSDATETIME()
)

-- BELL_LINKED_ITEMS is not required. 
...
go
select * from Bell_Cust_Master where isfordirectsales='Y'
select * from Bell_Cust_Master where area='SRR THOTA'
...
--alter table Bell_Cust_Master add IsForDirectSales varchar(3) default 'N'
--update Bell_Cust_Master set IsForDirectSales='NO' 
--update Bell_Cust_Master set IsForDirectSales='YES' where line in ('BAZAR','NEZAR','GATE','BHAVANI','ADILABAD','MAHARASHTRA')
...
-------------------------
SELECT * from bhavani_ER_Bills WHERE AREA='kamareddy' and billdate='2025-05-14' and username='SUGUNA'
order by billnumber 
update bhavani_ER_Bills set Billdate='2025-05-21' WHERE AREA='KAMAREDDY' and billdate='2025-05-14' and username='SUGUNA'
...
CREATE PROCEDURE BELL_SHOP_WISE_TOTAL_SALES  
@AREA AS NVARCHAR(20),  
@SHOP AS NVARCHAR(20),  
@BILLDATE1 AS DATE,  
@BILLDATE2 AS DATE,  
...
CREATE PROCEDURE BELL_SHOP_WISE_SALES_BY_BILLNUMBER
...
CREATE PROCEDURE BELL_GET_OPERATOR_NAME
@AREA AS NVARCHAR(50),
@BILLDATE1 AS DATE
AS
BEGIN
...
CREATE PROCEDURE USP_ITEMS_WISE_SALES_COUNT_BY_BILLDATE
@AREA AS NVARCHAR(20),
@SHOP AS NVARCHAR(20),
@BILLDATE1 AS DATE,
@BILLDATE2 AS DATE
...
CREATE PROCEDURE USP_ITEMS_WISE_SALES_COUNT_BY_ITEMNAME_OLD2
@TYPE AS NVARCHAR(20),    
@AREA AS NVARCHAR(max),    
@SHOP AS NVARCHAR(50),    
@ITEMNAME AS nVARCHAR(max),  
...
CREATE PROCEDURE USP_ITEMS_WISE_SALES_COUNT_BY_ITEMNAME_old  
@TYPE AS NVARCHAR(20),  
@AREA AS NVARCHAR(max),  
@SHOP AS NVARCHAR(50),  
@ITEMNAME AS nVARCHAR(max),
...
CREATE PROCEDURE USP_ITEMS_WISE_SALES_COUNT_BY_SHOP
@AREA AS NVARCHAR(20),
@SHOP AS NVARCHAR(20),
@BILLDATE1 AS DATE,
@BILLDATE2 AS DATE
...
-- USP_ITEMS_WISE_SALES_COUNT_BY_AREA '','Eturnagaram'
	CREATE PROCEDURE USP_ITEMS_WISE_SALES_COUNT_BY_AREA 
@BILLDATE AS DATE,
@AREA AS NVARCHAR(20)
AS
BEGIN
...
CREATE PROCEDURE USP_WEEKLY_SALE_ITEMS_COUNT 
@AREA AS NVARCHAR(20),
@SHOP AS NVARCHAR(20),
@BILLDATE1 AS DATE,
@BILLDATE2 AS DATE
...
CREATE PROCEDURE USP_WEEKLY_SALES_REPORT 
@BILLDATE AS DATE,
@AREA AS NVARCHAR(20)
AS
BEGIN
...
select * from BELL_USERS
CREATE PROCEDURE USP_SAVE_USER_DETAILS
@ID AS INT,
@USERNAME as varchar(20),
@PASSWORD as varchar(20),
...
CREATE PROCEDURE Bell_GET_CustomerDetails 
@ID AS int
AS
Begin	
	IF (isnull(@ID,'') <> '' )
...
CREATE PROCEDURE Bell_SAVE_CustomerLocation 
@ID as INT,
...
CREATE PROCEDURE BELL_GET_ItemsByMonth
@CUSTID as varchar(5),
@AREA as varchar(30),
@SHOP AS VARCHAR(50),
@ORDERDATE as date
...
CREATE PROCEDURE BELL_GET_All_Items 
...
CREATE PROCEDURE BELL_SP_GET_All_LS_Items  
@AREA as varchar(30) = NULL,
@SHOPNAME AS VARCHAR(50) = null
AS             
BEGIN  
...
-- BELL_GET_TOTAL_SALES_BY_AREA 'YELLAREDDYPETA','02-Jul-2024','01-14-2025'
 CREATE PROCEDURE BELL_GET_TOTAL_SALES_BY_AREA
@AREA as varchar(30) = null,
@FROMDATE AS DATE = null,
...
CREATE PROCEDURE BELL_GET_INACTIVE_SHOPS
@AREA as varchar(30),
@BILLDATE1 AS DATE,
@BILLDATE2 AS DATE
AS             
...
--BELL_GET_LS_ItemsByDate 'KHAMMAM','01-JAN-2023','01-14-2025'
 CREATE PROCEDURE BELL_GET_LS_ItemsByDate
@AREA as varchar(30) = null,
@FROMDATE AS DATE = null,
@TODATE AS DATE = null
AS             
...
CREATE PROCEDURE BELL_SP_GET_All_Customer_BILL_DETAILS --not using now
@AREA as varchar(30) = NULL,
@SHOP as varchar(30) = NULL
AS             
BEGIN  
...
CREATE PROCEDURE USP_MONTHLY_SALE_ITEMS_COUNT 
@BILLDATE1 AS DATE,
@BILLDATE2 AS DATE,
@AREA AS NVARCHAR(20),
@SHOP AS NVARCHAR(20)
...
CREATE PROCEDURE BELL_GET_STOCK_TRANSACTIONS
...
CREATE PROCEDURE BELL_GET_LS_ORDER_ITEMS 
@AREA as varchar(30),
...
CREATE PROCEDURE BELL_GET_STOCK_IN_OUT_BYITEM
